...
?>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
          	<div class="text mt-md-5">
	            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7064.253960955911!2d85.33672747265057!3d27.713365429263465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb1971009588ad%3A0x413d72dbcbe936fe!2sSiphal%2C%20Kathmandu%2044600!5e0!3m2!1sen!2snp!4v1572835552744!5m2!1sen!2snp" width="700" height="528" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
	            <!-- <a href="https://vimeo.com/45830194" class="icon-wrap popup-vimeo d-flex align-items-center mt-4"> -->
		            	<!-- <div class="icon d-flex align-items-center justify-content-center">
		            		<span class="ion-ios-play"></span>
		            	</div>
		            	<div class="heading-title ml-5">
			            	<span>Easy steps for renting a bus</span>
		            	</div> -->
	            </a>
            </div>
          </div>
 ...
 <p>
            ...
            <div class="media block-6 services">
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
	                ...
	                <h3 class="heading mb-0 pl-3">24/7 bus Support</h3>
                </div>
            ...
            <div class="media block-6 services">
              <div class="media-body py-md-4">
              	<div class="d-flex mb-3 align-items-center">
	                ...
	                <h3 class="heading mb-0 pl-3">Choose Seats</h3>
                </div>
                <p>A small river named Duden flows by their place and supplies it with you</p>
              </div>
            </div>      
    ...
    <section class="ftco-section">
    	<div class="container-fluid px-4">
    		<div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
          	<span class="subheading">Where to?</span>
            <h2 class="mb-2">Choose Your Destination</h2>
          </div>
        </div>
    		<!-- <div class="row">
    			<div class="col-md-3">
 ...
 -->    		</div>
  ...
  <source src="mats/video/bus.mp4" type="video/mp4">
  <source src="mats/video/bus.ogg" type="video/ogg">
