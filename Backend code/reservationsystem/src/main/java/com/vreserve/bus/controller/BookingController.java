...
import com.vreserve.bus.repo.BookingRepository;
...
public class BookingController {
	...
	public ResponseEntity<Booking> getBookingById(@PathVariable(value = "bookId") Integer bookId)
			throws ResourceNotFoundException {
		Booking booking = bookingRepository.findById(bookId)
				.orElseThrow(() -> new ResourceNotFoundException("Booking not found on :: " + bookId));
